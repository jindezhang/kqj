/****************************************************************************
** Meta object code from reading C++ file 'windownet.h'
**
...
#error "The header file 'windownet.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 42, 8), // "netFalse"
QT_MOC_LITERAL(5, 51, 24), // "on_pushButton_10_clicked"
QT_MOC_LITERAL(6, 76, 6) // "fanhui"

    },
    "netwindow\0on_bt_reset_clicked\0\0"
    "netTimeout\0netFalse\0on_pushButton_10_clicked\0"
    "fanhui"
};
...
void netwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->netFalse(); break;
        case 3: _t->on_pushButton_10_clicked(); break;
        case 4: _t->fanhui(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
