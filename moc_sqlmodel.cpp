...
QT_MOC_LITERAL(3, 19, 3), // "Net"
QT_MOC_LITERAL(4, 23, 4) // "data"

    },
    "sqlmodel\0sendData\0\0Net\0data"
};
...
void sqlmodel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< Net(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sqlmodel::sendData)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void sqlmodel::sendData(Net _t1)
{
