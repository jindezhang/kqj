...
QT_MOC_LITERAL(1, 9, 9), // "send_rfid"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4) // "rfid"

    },
    "myThread\0send_rfid\0\0rfid"
};
...
void myThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_rfid((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myThread::send_rfid)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void myThread::send_rfid(int _t1)
{
